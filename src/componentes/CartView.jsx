...
const CartView = () => {
  ...
  const[Apellido,setApellido]=useState("")
    ...
    const saveApellido = (event) =>setApellido(event.target.value)

  const ordenFuncion = () => {
       
        const collection =firestore.collection("ordenes")
        const orden = { Nombre,Apellido, Productos:carrito ,PrecioTotal:precioTotal(), Fecha:firebase.firestore.Timestamp.fromDate(new Date()) }
        precioTotal()
          ...
          <Form onSubmit={ordenFuncion} >
                 <Row className="align-items-center">
                           ...
                           <Col xs="auto">
                              ...
                              <FormControl onChange={saveApellido} className="mb-1" id="inlineFormInputGroup" placeholder="Apellido" />
